...
hl.define_submap("scratchpad_selector", function()
    for i = 1, 10 do
        local key = i % 10
        hl.bind(key, hl.dsp.workspace.toggle_special(key))
    end
